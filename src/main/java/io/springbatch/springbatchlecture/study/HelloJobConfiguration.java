...
//                .incrementer(new CustomJobParametersIncrementer())
                ...
                .start(jobStep(jobRepository,null, helloStep1))
                .next(helloStep2)
//                .next(customStep)
...
//    }
    ...
    @Bean
    public Job childJob(JobRepository jobRepository, Step helloStep1) {
    ...
    @Bean
    public Step jobStep(JobRepository jobRepository, JobLauncher jobLauncher, Step helloStep1) {
        return new StepBuilder("jobStep", jobRepository)
                .job(childJob(jobRepository, helloStep1))
